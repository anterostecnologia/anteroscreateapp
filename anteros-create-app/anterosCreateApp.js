...
const program = new commander.Command(packageJson.name)
  ...
  .option('-V', 'mostra a versão atual')
  .option('-help', 'mostra todas as opções disponíveis')
  .option('--verbose', 'mostra log adicionais')
  .option('--info', 'mostra informações de depuração do ambiente')
  .option('--use-redux', 'use redux na aplicação a ser gerada')
  .option('--use-anteros', 'use componentes Anteros na aplicação a ser gerada')
  .option(
...
function run(
  ...
  allDependencies.push('@babel/plugin-proposal-decorators',
  "babel-loader@8.0.5",
  "webpack@4.29.6",
  ...
  if (useAnteros===true){
    ...
    "source-map-explorer",
    "tween",
    'anteros-react-admin','anteros-react-buttons','anteros-react-charts','anteros-react-editors',
    'anteros-react-containers','anteros-react-core','anteros-react-dashboard',
    'anteros-react-datasource','anteros-react-dropzone','anteros-react-gridgallery',
    'anteros-react-image','anteros-react-label','anteros-react-layout',
    'anteros-react-list','anteros-react-loaders','anteros-react-masonry',
    'anteros-react-menu','anteros-react-misc','anteros-react-navigation',
    'anteros-react-nestable','anteros-react-notification','anteros-react-pivottable',
    'anteros-react-querybuilder','anteros-react-security','anteros-react-table',
    'anteros-react-theme','anteros-react-treeview'
    );
  }
